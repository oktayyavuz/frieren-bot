...
export async function updateWelcomeSettings(serverId: string, data: any) {
    return updateWelcomeLogSettings(serverId, data);
}

export async function updateWelcomeLogSettings(serverId: string, data: any) {
